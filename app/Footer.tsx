  ...
  return (
    ...
    >
       ...
       <div className="relative z-10 w-full px-4 mob-m:px-6 tablet:px-12 desktop:px-24 flex flex-col items-center">
          ...
          >
            <p className="font-inter text-[#D4A373] text-xs mob-m:text-sm tracking-[0.3em] mob-m:tracking-[0.4em] uppercase font-bold mb-3 mob-m:mb-4 drop-shadow-md">
              Become a Visionary
            </p>
            ...
            <div className="group relative cursor-pointer mb-6 mob-m:mb-8 text-center flex flex-col items-center">
               ...
               <div className="w-0 h-[3px] mob-m:h-[4px] bg-[#D4A373] mx-auto mt-3 mob-m:mt-4 transition-all duration-700 ease-out group-hover:w-3/4 opacity-50" />
            </div>
